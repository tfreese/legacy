...
/**
 * This is a sample element that extends <code>TickerElement</code> - the abstrat class that represents a ticker's text base element.
 * <p>
...
public class StockTickerElement extends AbstractTickerElement
{
     ...
     *
     * @param lastValue the last value of the stock
     */
