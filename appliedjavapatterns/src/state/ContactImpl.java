...
public class ContactImpl implements Contact
{
	 ...
	 */
	public ContactImpl(final String newFirstName, final String newLastName, final String newTitle, final String newOrganization)
	{
		super();
	...
	/**
	 * @see state.Contact#setLastName(java.lang.String)
	 */
	@Override
