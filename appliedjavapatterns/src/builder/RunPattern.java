...
public class RunPattern
{
    ...
    public static void main(final String[] arguments)
    {
        ...
        try
        {
            ...
            appt = pimScheduler.createAppointment(apptBuilder, createDate(2066, 9, 22, 12, 30), null, "Trek convention", new LocationImpl("Fargo, ND"),
                    createAttendees(4));
        ...
        try
        {
            ...
            appt = pimScheduler.createAppointment(mtgBuilder, createDate(2066, 9, 22, 12, 30), null, "Trek convention", new LocationImpl("Fargo, ND"),
                    createAttendees(4));
            System.out.println("Successfully created an Appointment.");
            System.out.println("Appointment information:");
            System.out.println(appt);
        ...
        try
        {
            appt = pimScheduler.createAppointment(mtgBuilder, createDate(2002, 4, 1, 10, 00), createDate(2002, 4, 1, 11, 30), "OOO Meeting",
