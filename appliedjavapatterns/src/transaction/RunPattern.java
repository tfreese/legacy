...
public class RunPattern
{
     ...
     * @return {@link Date}[]
     */
    private static Date[] getDates(final int year, final int month, final int day, final int hour, final int increment)
    {
    ...
    public static void main(final String[] arguments)
    {
        ...
        try
        {
            Process process = Runtime.getRuntime().exec("rmic -d target/classes -classpath target/classes transaction.AppointmentBook");
        ...
        System.out.println();
        Appointment apptOne =
                new AppointmentImpl("Swim relay to Kalimantan (or Java)", new ArrayList<Contact>(), new LocationImpl("Sidney, Australia"), createDate(2001, 11,
                        5, 11, 0));
        Appointment apptTwo =
                new AppointmentImpl("Conference on World Patternization", new ArrayList<Contact>(), new LocationImpl("London, England"), createDate(2001, 11,
                        5, 14, 0));
        Appointment apptThree =
                new AppointmentImpl("Society for the Preservation of Java - Annual Outing", new ArrayList<Contact>(), new LocationImpl("Kyzyl, Tuva"),
                        createDate(2001, 11, 5, 10, 0));
        ...
        System.out.println();
        System.out.println();
        boolean result = apptBookThree.changeAppointment(apptTwo, getDates(2001, 11, 5, 10, 3), lookUpParticipants(new String[]
        {
