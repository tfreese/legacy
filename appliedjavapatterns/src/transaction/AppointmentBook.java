...
public class AppointmentBook implements AppointmentTransactionParticipant
{
     ...
     *
     */
    private static final String TRANSACTION_HOSTNAME = "localhost:0";
    ...
    public AppointmentBook()
    {
        ...
        this.serviceName = "transactionParticipant" + INDEX++;
     ...
     */
    private void cancelAll(final long transactionID, final AppointmentTransactionParticipant[] participants) throws RemoteException
    {
     ...
     * @return boolean
     */
    public boolean changeAppointment(final Appointment appointment, final Date[] possibleDates, final AppointmentTransactionParticipant[] participants,
    ...
    /**
     * @see transaction.AppointmentTransactionParticipant#changeDate(long, transaction.Appointment, java.util.Date)
     */
    @Override
    public boolean changeDate(final long transactionID, final Appointment appointment, final Date newStartDate) throws TransactionException
    {
        if ((this.appointments.containsValue(appointment)) && (!this.appointments.containsKey(newStartDate)))
        {
     ...
     * @throws RemoteException Falls was schief geht
     */
    private void commitAll(final long transactionID, final AppointmentTransactionParticipant[] participants) throws TransactionException, RemoteException
    {
        for (AppointmentTransactionParticipant participant : participants)
        {
    ...
    {
        return "rmi://" + TRANSACTION_HOSTNAME + "/" + this.serviceName;
    }
     ...
     * @return boolean
     */
    private boolean isDateAvailable(final long transactionID, final Appointment appointment, final Date date,
