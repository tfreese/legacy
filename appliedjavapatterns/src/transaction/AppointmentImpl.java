...
public class AppointmentImpl implements Appointment
{
	 ...
	 */
	public AppointmentImpl(final String newDescription, final List<Contact> newAttendees, final Location newLocation, final Date newStartDate)
	{
		super();
	...
	/**
	 * @see transaction.Appointment#getLocation()
	 */
	@Override
	...
	{
		return "  Description: " + this.description + EOL_STRING + "  Start Date: " + this.startDate + EOL_STRING + "  Location: " + this.location + EOL_STRING
